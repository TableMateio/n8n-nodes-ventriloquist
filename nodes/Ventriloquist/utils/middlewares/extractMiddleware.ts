...
/**
 * Middleware for extraction operations
...
export async function executeExtraction(
	...
	logger.info(formatOperationLog('ExtractMiddleware', nodeName, nodeId, index,
	...
	try {
		...
		logger.error(formatOperationLog('ExtractMiddleware', nodeName, nodeId, index,
