...
export async function reconnectAfterNavigation(
  ...
  logger.info(formatOperationLog('SessionUtils', nodeName, nodeId, index,
  ...
  try {
    ...
    try {
      ...
      logger.warn(formatOperationLog('SessionUtils', nodeName, nodeId, index,
      ...
      if (sessionId) {
        try {
          ...
          logger.error(formatOperationLog('SessionUtils', nodeName, nodeId, index,
 ...
 */
export function detectUrlChange(beforeUrl: string, afterUrl: string, options: {
